 ...
 */
public abstract class Hilt_QuestionsFragment<T extends ViewBinding, V extends ViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuestionsFragment_GeneratedInjector) this.generatedComponent()).injectQuestionsFragment(UnsafeCasts.<QuestionsFragment>unsafeCast(this));
    }
  }
