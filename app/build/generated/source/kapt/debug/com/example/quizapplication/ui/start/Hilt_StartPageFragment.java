 ...
 */
public abstract class Hilt_StartPageFragment<T extends ViewBinding, V extends ViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartPageFragment_GeneratedInjector) this.generatedComponent()).injectStartPageFragment(UnsafeCasts.<StartPageFragment>unsafeCast(this));
    }
  }
